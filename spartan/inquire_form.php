...
<div class="form_widget">
  ...
  <div class="content">
    ...
    <div class="form-group">
      <textarea name="ProjectBrief" placeholder="*Brief about the Product" required oninvalid="this.setCustomValidity('Please enter Brief about the project')" oninput="setCustomValidity('')"></textarea>
